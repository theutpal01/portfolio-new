...
const Project = ({title, image, description, github_url, site_url} : ProjectType) => {
  return (
	<div className='w-full flex flex-col lg:flex-row py-5 gap-5'>
				<div className='w-full lg:w-7/12 flex justify-start group overflow-hidden rounded-lg'>
					<Image
						...
						width={700}
						height={300}
						className='shadow-lg w-full max-h-96 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out'
					/>
				</div>
